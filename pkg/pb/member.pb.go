...
type MemberMsg struct {
	...
	File      *string `protobuf:"bytes,3,req,name=file" json:"file,omitempty"`
}
...
func (x *MemberMsg) GetCid() string {
	if x != nil && x.Cid != nil {
		return *x.Cid
	}
	return ""
...
func (x *MemberMsg) GetSignature() []byte {
	if x != nil {
		return x.Signature
	}
	return nil
...
func (x *MemberMsg) GetFile() string {
	if x != nil && x.File != nil {
		return *x.File
	}
	return ""
...
var file_member_proto_rawDesc = []byte{
	,
}
